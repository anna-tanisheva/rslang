...
import { restartGameHandler } from "./restartSprint";
...
export class SprintView {
    ...
    create() {
        ...
        const closeButtonAttributes = {type: "button", class: "sprint-button sprint-close-button" };
        const closeButton = createElementWithAttributes( "button", closeButtonAttributes );
        closeButton.textContent = "Закрыть";
        const resultBtnsContainer = createElementWithClassnames( "div", "sprint-buttons");
        resultBtnsContainer.append(restartButton, closeButton);
